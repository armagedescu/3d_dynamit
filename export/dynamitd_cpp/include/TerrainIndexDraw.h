...
#include <glm/glm.hpp>
#include "tess.h"
class TerrainIndexDraw : public Shape
{
...
public:
	...
	TerrainIndexDraw(const wchar_t* heigthsMapPath);
	TerrainIndexDraw(const wchar_t* heigthsMapPath, const char* vertexPath, const char* fragmentPath);
	TerrainIndexDraw(const char* vertexPath, const char* fragmentPath);
	void build();
