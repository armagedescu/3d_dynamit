...
#include <glm/glm.hpp>
#include "tess.h"
class TerrainIndexed : public Shape
{
...
public:
	...
	TerrainIndexed(const wchar_t* heigthsMapPath);
	TerrainIndexed(const wchar_t* heigthsMapPath, const char* vertexPath, const char* fragmentPath);
	TerrainIndexed(const char* vertexPath, const char* fragmentPath);
	void build();
