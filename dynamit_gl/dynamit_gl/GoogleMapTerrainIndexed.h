...
#include <glm/glm.hpp>
#include "tess.h"
class GoogleMapTerrainIndexed : public Shape
{
...
public:
	...
	GoogleMapTerrainIndexed(const wchar_t* heigthsMapPath);
	GoogleMapTerrainIndexed(const wchar_t* heigthsMapPath, const char* vertexPath, const char* fragmentPath);
	GoogleMapTerrainIndexed(const char* vertexPath, const char* fragmentPath);
	void build();
