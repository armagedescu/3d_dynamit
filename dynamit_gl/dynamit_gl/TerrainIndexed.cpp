...
const wchar_t* TerrainIndexed::defTerrainImgPath = L"bitmaps/heightmap.bmp";

TerrainIndexed::TerrainIndexed(const wchar_t* heigthsMapPath)
	: TerrainIndexed(heigthsMapPath, "shaders/terrainIndexed.vs", "shaders/terrainIndexed.fs")
{
}
TerrainIndexed::TerrainIndexed(const char* vertexPath, const char* fragmentPath)
	: TerrainIndexed(defTerrainImgPath, vertexPath, fragmentPath)
{}

TerrainIndexed::TerrainIndexed(const wchar_t* heigthsMapPath, const char* vertexPath, const char* fragmentPath)
...
int TerrainIndexed::fillHeightMapBuffer(float size, float h)
{
...
void TerrainIndexed::drawInit(glm::mat4& model, glm::mat4& view, glm::mat4& projection, const glm::vec4& color)
{
	glUseProgram(*this);
